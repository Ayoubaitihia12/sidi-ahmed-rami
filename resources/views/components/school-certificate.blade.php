...
<div style="border: 1px solid #e2e8f0; border-radius: 0.375rem; padding: 1.5rem; padding-bottom: 4rem; margin-top: 0.5rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); align-items: start; font-size: 0.875rem; column-gap: 1rem;">
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); column-gap: 0.2rem;margin-top:-10px">
                <ul style="font-weight: 300;line-height: 1.5;text-align: right">
                    <li style="list-style-type: none;font-size:12px">سوس - ماسة</li>
                    <li style="list-style-type: none;font-size:12px">عمالة : اكادير اداوتنان</li>
                </ul>
        ...
        <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); column-gap: 0.2rem">
            <ul style="font-weight: 300;line-height: 1.5;text-align: right">
                <li style="list-style-type: none;font-size:12px">{{ $user['commune'] ? $user['commune'] : '---------------' }}</li>
                <li style="list-style-type: none;font-size:12px">{{ $user['name'] ? $user['name'] : '------------------' }}</li>
                <li style="list-style-type: none;font-size:12px">{{ $user['phone'] ? $user['phone'] : '---------------' }}</li>
            </ul>
            <ul style="font-weight: 500;line-height: 1.5;text-align: right">
    ...
    <div style="border-width: 2px; margin-top: 1.5rem; border: 2px solid #000000; padding-left: 0.25rem; padding-right: 0.25rem; padding-top: 0.1rem; padding-bottom: 0.1rem;">
        <h3 style="text-align: center; font-weight: 600; font-size: 0.875rem;">شهادة مدرسية رقم : {{ $user['certificate_number'] }} {{ date('Y') }} </h3>
    </div>
    ...
    <div style="font-size: 0.875rem; margin-top: 2.5rem; margin-bottom: 1rem;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 2rem;">
            <p style="float: right">خاتم و توقيع رئيس المؤسسة</p>
...
<div style="border: 1px solid #e2e8f0; border-radius: 0.375rem; padding: 1.5rem; padding-bottom: 4rem; margin-top: 0.5rem;">
    ...
    <div style="font-size: 0.875rem; margin-top: 2.5rem; margin-bottom: 1rem;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 2rem;">
            <p style="margin-right: 30px">خاتم و توقيع رئيس المؤسسة</p>
            <p>خاتم و توقيع الحارس العام / الناطر المسؤول عن المعلومات الواردة في الشهادة</p>
        </div>
    </div>
